              ...
              <div class="row">
                 ...
                 <center>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="" placeholder="e.g Nelson Sechere appointed as e" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="source" value="" placeholder="e.g KBC" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="" placeholder="e.g https://kbc.co.ke/" class="form-control" />
                        </div>
                    </div>
