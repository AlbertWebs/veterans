				...
				@endif
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="source" value="{{$Blog->source}}" placeholder="e.g KBC" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="text1" name="link" value="{{$Blog->link}}" placeholder="e.g https://kbc.co.ke/" class="form-control" />
                        </div>
                    </div>
                    ...
                    <div class="form-group col-lg-12">
                        ...
                        <div class="">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="{{url('/')}}/uploads/blogs/{{$Blog->image}}" alt="" /></div>
                    ...
                    <input type="hidden" name="image_cheat" value="{{$Blog->image}}">
