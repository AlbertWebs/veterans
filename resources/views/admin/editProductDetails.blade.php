              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_Product_Details')}}/{{$Product->id}}" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                ...
                                <div id="div-1" class="body collapse in">
                                        ...
                                        <textarea rows="40" name="content" id="wysihtml5" class="form-control" rows="10">{{$Product->content}}</textarea>
