            ...
            <div class="inner" style="min-height: 700px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center><h2> Edit Core Values </h2></center>
              ...
              <div class="row">
               <center>
				...
				@endif
                 ...
                 <form class="form-horizontal" method="post"  action="{{url('/admin/edit_values')}}/{{$Value->id}}">
                   
                 <div class="form-group">
                        <label for="text1" class="control-label col-lg-4">Title</label>

                        <div class="col-lg-8">
                            <input type="text" id="text1" name="title" value="{{$Value->title}}" class="form-control" />
                        </div>
                    </div>
                        <div class="col-lg-12">
                            <div class="box">
